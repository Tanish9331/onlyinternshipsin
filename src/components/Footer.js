        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Your trusted partner in internship success. We connect talented students with leading companies through our comprehensive assessment platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#features" className="text-gray-300 hover:text-orange-400 transition-colors duration-300">Features</a></li>
              <li><a href="#pricing" className="text-gray-300 hover:text-orange-400 transition-colors duration-300">Pricing</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors duration-300">Contact Us</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm">
              <span className="text-gray-400">GST: 27ABCDE1234F1Z5</span>
